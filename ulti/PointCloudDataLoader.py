...
import os
import ulti.provider as provider
...
class PointCloudDataLoader(Dataset):
    def __init__(self, root, split, num_pcs = 196, startIndex_split = None, endIndex_split = None):
        ...
        x_data = x_data.reshape(x_data.shape[0], num_pcs, 5)
        x_data = np.transpose(x_data, (0, 2, 1))

        #this line insert more dimension, uncomment if needed
       # x_data = np.insert(x_data, 5, 0, axis = 1) #insert dimension for a 5-dimension pc
